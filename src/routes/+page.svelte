<div class="layout-md text-lg">
	<div class="grid grid-cols-3 sm:grid-cols-1 sm:space-y-3">
		<div class="col-span-2 mr-4 text-neutral-600 font-mabry sm:col-span-1">
			<p>
				👋 I'm a <a href="classes"><em>senior</em></a> at MIT studying math and computer science. I'm
			...
			<p>
				☁️ I mostly recently worked at <a href="https://www.modal.com/" target="_blank"
					><em>Modal</em></a
				>
